        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Preparacao = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientesDaReceita", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IngredientesDaReceita_Ingredientes_IngredienteId",
                        column: x => x.IngredienteId,
                        principalTable: "Ingredientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IngredientesDaReceita_Receitas_ReceitaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IngredientesDaReceita_IngredienteId",
                table: "IngredientesDaReceita",
                column: "IngredienteId");

            migrationBuilder.CreateIndex(
                name: "IX_IngredientesDaReceita_ReceitaId",
                table: "IngredientesDaReceita",
                column: "ReceitaId");
        }
